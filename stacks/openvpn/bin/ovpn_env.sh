...
declare -x OVPN_CN=eweiss.servebeer.com
...
declare -x OVPN_ENV=/opt/code/cont/mysql/docker-openvpn/bin/ovpn_env.sh
...
declare -x OVPN_SERVER_URL=eweiss.servebeer.com
